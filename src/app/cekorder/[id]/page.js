      ...
      <div className="relative flex flex-col items-center p-6 md:p-10 text-white">
        ...
        {orderDetails && (
          <div className="bg-black bg-opacity-10 backdrop-blur-sm p-6 rounded-lg w-full max-w-2xl">
            {/* Order Summary */}
            <div className="mb-8">
              <h2 className="text-xl font-semibold mb-4 border-b border-white border-opacity-30 pb-2">
                Informasi Pesanan
              </h2>
                ...
                {orderDetails.items.map((item, index) => (
                  <div key={index} className="flex gap-4 items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-white text-opacity-70 line-clamp-1">
                        {item.description}
                      </p>
        ...
        {status && (
          <div className="mt-6 bg-white bg-opacity-10 backdrop-blur-sm p-6 rounded-lg w-full max-w-2xl">
            ...
            >
              ...
              {!["pending", "settlement", "expire", "deny", "cancel"].includes(
                status
              ) && status}
            </div>
